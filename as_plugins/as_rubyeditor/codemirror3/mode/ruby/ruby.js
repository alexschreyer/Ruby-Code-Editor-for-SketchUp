    ...
    token: function(stream, state) {
      ...
      if (style == "ident") {
        ...
        style = keywords.propertyIsEnumerable(stream.current()) ? "keyword"
          // AS Added the following two lines!
